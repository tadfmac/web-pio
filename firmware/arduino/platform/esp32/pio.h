...
#define DEVICE_INIT      0x08
#define GPIO_EXPORT      0x10
#define GPIO_WRITE       0x11
#define GPIO_READ        0x12
#define GPIO_UNEXPORT    0x13
#define GPIO_ONCHANGE    0x14
#define GPIO_UNEXPORTALL 0x15
#define GPIO_SETPWM      0x16
#define GPIO_ANALOGREAD  0x17
...
// BLEMIDI_CREATE_INSTANCE("web-pio", MIDI) expands to:
//   bleMidi::BLEMIDI_Transport<bleMidi::BLEMIDI_ESP32> BLEMIDI("web-pio");
//   midi::MidiInterface<bleMidi::BLEMIDI_Transport<bleMidi::BLEMIDI_ESP32>, bleMidi::MySettings> MIDI(BLEMIDI);
extern MIDI_NAMESPACE::MidiInterface<BLEMIDI_NAMESPACE::BLEMIDI_Transport<BLEMIDI_NAMESPACE::BLEMIDI_ESP32>, BLEMIDI_NAMESPACE::MySettings> MIDI;
